  ...
  return (
    <>
      <div>
        ...
        <h1 className="lg:text-5xl md:text-4xl text-2xl font-medium px-4 leading-10 text-primary-red mt-6 text-center font-heading">
        ...
        <div className="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 xl:px-20 px-10 py-20 gap-6">
          <div>
            <div className="group w-full bg-primary-white relative flex flex-col items-center hover:bg-primary-red cursor-pointer shadow-md md:p-12 p-6">
              <div className="text-gray-600 group-hover:text-primary-yellow flex flex-col items-center">
                <svg
                  width={26}
                  height={27}
                  viewBox="0 0 26 27"
                ...
                <p className="xl:w-80 text-base leading-normal text-center mt-4">
                  The hospitality and services provided by each staff of the
                  hotel were excellent, they attended us well at all times and
                  we were impressed by their courtesy. We enjoyed our stay and
                  convey thanks to all associated with the hotel.
                </p>
              </div>
          ...
          <div>
            <div className="group w-full bg-primary-white relative flex flex-col items-center hover:bg-primary-red cursor-pointer shadow-md md:p-12 p-6">
              <div className="text-gray-600 group-hover:text-primary-yellow flex flex-col items-center">
                ...
                <p className="xl:w-80 text-base leading-normal text-center mt-4">
                  The hotel is meticulous in its planning, providing excellent
                  décor, signage and the like. Importantly, they never seemed to
                  tire of the constant emails from an equally meticulous event
                  manager. Always prompt and attentive.
                </p>
              </div>
              <div className="text-white group-hover:text-indigo-700 absolute bottom-0 -mb-6">
                <svg
          ...
          <div>
            <div className="group w-full bg-primary-white relative flex flex-col items-center hover:bg-primary-red cursor-pointer shadow-md md:p-12 p-6">
              <div className="text-gray-600 group-hover:text-primary-yellow flex flex-col items-center">
                ...
                <p className="xl:w-80 text-base leading-normal text-center mt-4">
                  Beyond 5 stars! Stayed last week at this wonderful hotel.
                  Everything exceeds ones wildest dream of a hotel. On top they
                  have the most wonderful staff, extremely kind and helpful with
                  every wish. This is indeed a place you do not want to leave.
                </p>
              </div>
              <div className="text-white group-hover:text-indigo-700 absolute bottom-0 -mb-6">
                <svg
