  ...
  return (
    <>
      ...
      <div className="w-full grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        <div className="bg-primary-white rounded shadow px-8 py-6 flex items-center">
          <div className="p-4 bg-dark-pink rounded">
            <svg
        ...
        <div className="bg-primary-white rounded shadow px-8 py-6 flex items-center">
          <div className="p-4 bg-dark-pink rounded text-primary-white">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="ml-6">
            <h3 className="mb-1 leading-5 text-gray-800 dark:text-gray-100 font-bold text-2xl">
              {rooms.length !== 0 &&
                rooms
                  .map((room) => room.roomAvailability)
        ...
        <div className="bg-primary-white dark:bg-gray-800 rounded shadow px-8 py-6 flex items-center">
          <div className="p-4 bg-dark-pink rounded text-primary-white">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="ml-6">
            <h3 className="mb-1 leading-5 text-gray-800 dark:text-gray-100 font-bold text-2xl">
              ...
              {reservations.length !== 0 &&
                reservations
                  .map((reservation) => reservation.totalPayment)
                  .reduce((start, next) => (start += next))}
            </h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm tracking-normal font-normal leading-5">
              Profit Earned
